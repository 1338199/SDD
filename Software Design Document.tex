...
\subsubsection{Design for Updating Posture data}
\begin{itemize}
    \item Input: new standard posture data
    \item Output: updating outcome
    \item Logical Flow:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.1\textwidth]{diagrams/flow-updatePosture.png}
        \caption{Logical Flow For Updating}
    \end{figure}
\end{itemize}
...
\end{figure}
	...
	\begin{enumerate}
		...
		\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{diagrams/setid.png}\\
\end{figure}
\end{enumerate}
	\item getName
	\begin{enumerate}
		\item Parameters: null
		\item Return Type: String
		\item Function: Return the account name of the user.
		\item Implement:
		\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{diagrams/getname.png}\\
\end{figure}
\end{enumerate}
	\item setName(String name):void
	\begin{enumerate}
		\item Parameters: String name
		\item Return Type: void
		\item Function: Set the account name of the user.
		\item Implement:
		\begin{figure}[H]
	\centering
	\includegraphics[width=1.\textwidth]{diagrams/setname.png}\\
\end{figure}
	\end{enumerate}
\end{enumerate}
